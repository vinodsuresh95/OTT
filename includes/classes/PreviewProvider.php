...
class PreviewProvider {
    ...
    public function createPreviewVideo($entity) {
        ...
        $seasonEpisosde = $video->getSeasonAndEpisode();
        $subHeading = $video->isMovie() ? "" : "<h4>$seasonEpisosde</h4>";
        			...
        			<div class='previewOverlay'>
        				<div class='mainDetails'>
                            <h3>$name</h3>
                              $subHeading
                                <div class='buttons'>
                                     <button onclick='watchNextVideo($videoId)' ><i class='fas fa-play'></i> $playButtonText </button>
